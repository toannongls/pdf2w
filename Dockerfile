...
# tesseract-ocr: Công cụ Tesseract chính
# tesseract-ocr-vie: Gói ngôn ngữ tiếng Việt cho Tesseract (rất quan trọng cho OCR tiếng Việt)
# poppler-utils: Công cụ Poppler cần thiết cho pdf2image
# libpoppler-dev: Thư viện phát triển Poppler (đôi khi cần)
